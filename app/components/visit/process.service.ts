...
export class ProcessService {
    ...
    getDeployedApplication(name: string): Observable<Process> {
    ...
    getProcessDefinitionByApplication(application: any): Observable<Process> {
        return this.getProcessDefinitions()
            .map((processes: any) => <Process> processes.data.find(p => p.deploymentId === application.deploymentId));
    }
    ...
    startProcessByID(processDefinitionId: string, processName: string): Observable<any> {
